...
public class Auditoria extends javax.swing.JFrame {
    ...
    public Auditoria(String user) {
        ...
        CAuditoria c = new CAuditoria();
        List<String> auditoria = c.obtenerAuditorias();

        llenarTabla(auditoria);
    }
    ...
    private void llenarTabla(List<String> auditorias) {
        // Crear un modelo de tabla con las columnas correspondientes
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.addColumn("ID");
        modelo.addColumn("Accion");
        modelo.addColumn("SaleID");
        modelo.addColumn("Cambio");
        modelo.addColumn("Realizado Por");
        modelo.addColumn("Fecha");

        // Dividir las cadenas y añadirlas como filas al modelo
        for (String auditoria : auditorias) {
            // Separar los datos individuales (basado en tu formato de string)
            String[] datos = auditoria.split(", ");
            Object[] fila = new Object[datos.length];

            // Extraer los valores desde cada campo
            for (int i = 0; i < datos.length; i++) {
                // Obtener solo el valor después de ": "
                fila[i] = datos[i].substring(datos[i].indexOf(":") + 2);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Accion", "SaleID", "Cambio", "Realizado_Por", "Fecha"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 740, -1));
