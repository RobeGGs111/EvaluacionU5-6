 ...
 * @author s2212
 */
public class Reporte_Trimestral extends javax.swing.JFrame {

    Conexion cx;
    String user;
    public Reporte_Trimestral(String user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 247, -1, 350));

        txtAnio.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        txtAnio.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(txtAnio, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, 240, 60));
        ...
        jPanel1.add(btnConsultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 160, 190, 60));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("AÑO");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 220, -1, -1));
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        int a = Integer.parseInt(txtAnio.getText()); // Aquí puedes poner el mes que el usuario seleccione
        DefaultTableModel modelo = cVistas.mostrarReporteVentasT(a);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte_Trimestral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte_Trimestral().setVisible(true);
            }
        });
    }
